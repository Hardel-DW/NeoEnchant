...
execute positioned ~ ~1 ~ if block ~ ~ ~ #enchantplus:veinminer run function enchantplus:actions/vein_miner/propagate
execute positioned ~ ~-1 ~ if block ~ ~ ~ #enchantplus:veinminer run function enchantplus:actions/vein_miner/propagate
execute positioned ~1 ~ ~ if block ~ ~ ~ #enchantplus:veinminer run function enchantplus:actions/vein_miner/propagate
execute positioned ~-1 ~ ~ if block ~ ~ ~ #enchantplus:veinminer run function enchantplus:actions/vein_miner/propagate
execute positioned ~ ~ ~1 if block ~ ~ ~ #enchantplus:veinminer run function enchantplus:actions/vein_miner/propagate
...
execute positioned ~1 ~1 ~ if block ~ ~ ~ #enchantplus:veinminer run function enchantplus:actions/vein_miner/propagate
execute positioned ~-1 ~1 ~ if block ~ ~ ~ #enchantplus:veinminer run function enchantplus:actions/vein_miner/propagate
execute positioned ~1 ~-1 ~ if block ~ ~ ~ #enchantplus:veinminer run function enchantplus:actions/vein_miner/propagate
execute positioned ~-1 ~-1 ~ if block ~ ~ ~ #enchantplus:veinminer run function enchantplus:actions/vein_miner/propagate
execute positioned ~1 ~ ~1 if block ~ ~ ~ #enchantplus:veinminer run function enchantplus:actions/vein_miner/propagate
