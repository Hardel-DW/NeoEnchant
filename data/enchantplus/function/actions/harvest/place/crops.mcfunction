...
execute store result storage enchantplus:harvest size int -1 store result score #size enchantplus.data run data get entity @s Inventory[{Slot:-106b}].components."minecraft:enchantments".levels."enchantplus:hoe/harvest"
