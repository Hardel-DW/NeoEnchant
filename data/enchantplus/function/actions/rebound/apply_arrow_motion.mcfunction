...
tellraw @a[tag=enchantplus.debug] [{"text":"Motion: "},{"score":{"name":"#dx","objective":"enchantplus.data"}},{"text":" "},{"score":{"name":"#dy","objective":"enchantplus.data"}},{"text":" "},{"score":{"name":"#dz","objective":"enchantplus.data"}}]
tellraw @a[tag=enchantplus.debug] [{"text":"Motion: "},{"nbt":"Motion","entity":"@s"}]