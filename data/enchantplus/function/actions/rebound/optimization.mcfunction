...
execute unless block ~ ~ ~-1 #minecraft:replaceable store result entity @s Motion[2] double -0.005 run scoreboard players get @s enchantplus.rebound_vz
execute unless entity @s[nbt={inBlockState:{Name:"minecraft:target"}}] unless score @s enchantplus.rebound_vz matches -7..7 unless score @s enchantplus.rebound_vx matches -7..7 unless score @s enchantplus.rebound_vy matches -13..-10 run data modify entity @s inGround set value 0b
